...
wait = WebDriverWait(brower, TIMEOUT)
...
def parse_detail():
    ...
    cover = brower.find_element_by_css_selector('.cover').get_attribute('src')
    score = brower.find_element_by_class_name('score').text
    ...
    try:
        for page in range(1,TOTAL_PAGE + 1):
            ...
            for detail_url in list(detail_urls):
                logging.info('get detail url %s', list(detail_url))
